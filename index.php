...
// Endpoint LOCAL para validação do merchant
// OPÇÃO 1: Com certificados reais (recomendado)
const VALIDATE_ENDPOINT = './validate-merchant.php';

// OPÇÃO 2: Mock para testar SEM certificados (descomente a linha abaixo)
// const VALIDATE_ENDPOINT = './validate-merchant-mock.php';

// OPÇÃO 3: Endpoint remoto (backup)
